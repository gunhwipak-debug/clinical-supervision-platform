...
This matrix maps the original plan now archived at `docs/_archive/2026-06-15/old-prompts/codex-piped-quiche.md` to historical implementation evidence. It is not the current UI/UX source of truth.
